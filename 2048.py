...
#actions_dict = {87: 'Up', 83: 'Down', 65: 'Left', 68: 'Right', 82: 'Restart', 81: 'Exit', 119: 'Up', 115: 'Down', 97: 'Left', 100: 'Right', 114: 'Restart', 113: 'Exit'}
...
#            line = '+------+------+------+------+'
        ...
        def draw_row(row):
            cast(''.join("|{0: ^6}".format(num) if num > 0 else "|      " for num in row) + '|')
